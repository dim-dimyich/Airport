...
import com.qoobico.remindme.adapter.ChatRoomsAdapter;
...
import com.qoobico.remindme.gcm.NotificationUtils;
import com.qoobico.remindme.helper.SimpleDividerItemDecoration;
import com.qoobico.remindme.model.ChatRoom;
...
public class ChatRoomsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chatrooms_layout);
        ...
        recyclerView.addOnItemTouchListener(new ChatRoomsAdapter.RecyclerTouchListener(getApplicationContext(), recyclerView, new ChatRoomsAdapter.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(ChatRoomsActivity.this, ChatRoomActivity.class);
